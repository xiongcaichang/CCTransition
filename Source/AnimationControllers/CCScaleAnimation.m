...
#import "CCScaleAnimation.h"

@implementation CCScaleAnimation
...
- (void) animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext fromView:(UIView *)fromView toView:(UIView *)toView
{
    ...
    CGFloat zoomingScale = (self.type == CCScaleAnimationFadeIn) ? 0.8 : 2.0;
    CGFloat springScale = (self.type == CCScaleAnimationFadeIn) ? 1.2 : 2.2;
